  ...
  return (
    <div className='py-32 px-10 bg-[#0FC0D9] relative rounded-lg h-[500px] leading-[0.9] w-full'>
      <div>
        ...
        <h3 className='text-6xl mt-1 font-semibold'>{heroBanner.midText}</h3>
        <h1 className='text-white text-9xl ml-[-20px] uppercase font-bold'>{heroBanner.largeText1}</h1>
        <img src={urlFor(heroBanner.image)} alt='logo' className='absolute top-0 right-[20%] h-[450px] w-[450px]' />
        <div>
